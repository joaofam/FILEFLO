...
export default function FileUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setHashValue(cleanValues.hashValue);
    setEncyptedValue(cleanValues.encyptedValue);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(File, idProp)
        : fileModelProp;
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            File.copyOf(fileRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "FileUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || fileModelProp)}
